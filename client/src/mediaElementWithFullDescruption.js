...
function MediaElementWithFullDescription(){
    ...
    return(
        ...
        </div>
      {
        (!shopItemFull) ? '':
         <>  
        <div className='fullShopItemContainer' >
        <div className="shopItemFull" >
    ...
    <div className='shopItemInfoSection'>
        <div className='shopItemButtonContainer'>
            ...
            style={{textUnderlineOffset: buttonSelected === "Product Details" ? "-25px" : "none", textDecoration: buttonSelected === "Product Details" ? "underline" : "none" }}
            onClick={event=>handleChangeTab(event,'value')} value={"Product Details"}>
              Product Details
            </button>
            <button className='productSizingButton' 
            style={{textUnderlineOffset: buttonSelected === "Sizing & Specs" ? "-25px" : "none", textDecoration: buttonSelected === "Sizing & Specs" ? "underline" : "none" }} 
            onClick={event=>handleChangeTab(event,'value')} value="Sizing & Specs">
              Sizing & Specs
            </button>
        </div>
        {(buttonSelected === "Product Details") ?  
        <div className='shopItemButtonIntoContainer'><p>{shopItemFull.itemProductDetails}</p></div>  :

        (shopItemFull?.itemSizingSpecs[0] === null) ? '' :
